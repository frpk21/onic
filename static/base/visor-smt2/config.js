	...
	"layers": [
		{
			...
			"typeName": "geonode:comunidades_4686_definitivo",
			"visible": false,
			"popup": true,
		...
		
		{
			...
			"outFields": [
				...
				{"name": "pueblo_onic", "alias": "Pueblo"},
				{"name": "macro", "alias": "Macro"},
				{"name": "org_nal", "alias": "Organización Nacional"},
				{"name": "org_regnal", "alias": "Organización Regional"},
				{"name": "dpto_cnmbr", "alias": "Departamento"},
				{"name": "dpto_ccdgo", "alias": "Código Departamento"},
				{"name": "mpio_cnmbr", "alias": "Municipio"},
				{"name": "mpio_cdpmp", "alias": "Código Municipio"},
				{"name": "area_pg_ha", "alias": "Área (ha)", "type": "numeric"}
			],
				"queryWidget": {
				"queries" : [
					{"name": "territorio", "alias": "Resguardo"},
		...
		
		{
			...
			'EPSG': 4686,
			"url": "https://smt-test.onic.org.co/geoserver/wfs?",
			"typeName": "geonode:dptos_resguardos_campos",
			"visible": false,
			"popup": true,
			"showCoverageOnHover": false,
			"removeOutsideVisibleBounds": false,
